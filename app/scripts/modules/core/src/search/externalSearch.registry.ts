...
export interface IExternalSearchConfig {
  ...
  /**
   * Specifies the property mapping from filter keys to external search result object properties.
   *
   * e.g. a filter key might be `account`, but the search result object property might be `env`
   */
  filterMapping: IFilterMapping;
...
export class ExternalSearchRegistry {
  ...
  public getFilterMapping(key: string): IFilterMapping {
    return this.registry[key].filterMapping;
  }
}
